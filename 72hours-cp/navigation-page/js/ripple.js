(function(){
	...
	switch(window.devicePixelRatio){
		case 1:
			ripple_without_diameter = 60;
			break;
		case 2:
			ripple_without_diameter = 120;
			break;
		case 3:
			ripple_without_diameter = 180;
			break;
		default:
			ripple_without_diameter = 50;
	}
	var overlays = {
		items: [],
		get: function(){
			...
			return function(){
				...
				switch($element.transition_phase){
					...
					case 2:
						...
						setTimeout($element.next_transition, 0.6 * 1000);
						break;
					case 3:
